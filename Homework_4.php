                ...
                <fieldset>
                    ...
                    <div>
                        ...
                        <?php
                            ...
                            print("<input type='radio' name='sav' value='no2'>Nuh Uh<br>");
                        ?>
                        </select>
                    </div>  
                    <div>
                        ...
                        <?php
                            print("<input type='radio' name='cut' value='weird' required>Straight down in half<br>");  
                            print("<input type='radio' name='cut' value='weirder'>In quarters<br>");
                            print("<input type='radio' name='cut' value='proper'>Diagonally<br>");
                            print("<input type='radio' name='cut' value='quick'>Whole<br>");
                        ?>
                        </select>
                    </div>  
                    <div>
