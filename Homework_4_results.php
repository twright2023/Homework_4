...
<html lang="en-US">
    ...
    <?php
        ...
        switch ($toast) {
            case "0": $EternalYouth["5-10 Years Old"] += 2; break;
            case "0": $EternalYouth["11-20 Years Old"] += 2; break;
            case "1": $EternalYouth["21-30 Years Old"] += 2; break;
            case "2": $EternalYouth["31-40 Years Old"] += 2; break;
            case "2": $EternalYouth["41-50 Years Old"] += 2; break;
            case "3": $EternalYouth["50+ Years Old"] += 2; break;
        }
